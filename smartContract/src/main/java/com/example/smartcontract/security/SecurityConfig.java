package com.example.smartcontract.security;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/addUser/**" ,"/approveUser/**",
                "/sell_immobiliers/**","/immobillierDetails/**","/approveChangeOwnerShip/**",
                "/changeOwnerShip/**","/sellImmobilier/**","/changeOwnerShip2/**").permitAll();
